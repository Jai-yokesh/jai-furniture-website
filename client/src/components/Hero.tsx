...
<section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 px-4 md:px-6 pt-6">
        <div className="max-w-3xl space-y-8">
          ...
          >
            <h1 className="text-5xl md:text-7xl lg:text-8xl leading-tight">
              <span className="block font-serif font-light text-foreground">
                Traditional
              </span>
              <span className="block font-serif italic text-primary/80">
                Tile-Inlaid
              </span>
              <span className="block font-serif font-bold text-accent">
                Furniture
              </span>
            </h1>
          </motion.div>
          ...
          >
            Experience the timeless elegance of handmade Athangudi tiles
            embedded in premium 100% teakwood. A heritage of craftsmanship for
            your modern home.
          </motion.p>
...
className="mt-12 pt-6 border-t border-primary/10 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl"
        >
          {[
            { label: "Years of Craft", value: `${years}+` },
