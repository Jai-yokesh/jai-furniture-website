...
export default function Contact() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    const phoneE164 = "919597464680";
    const lines = [
      "Hi Jai Furniture! I want a quote.",
      `Name: ${values.name}`,
      `Phone: ${values.phone}`,
    ...
    const waLink = `https://wa.me/${phoneE164}?text=${encodeURIComponent(lines.join("\n"))}`;
    window.open(waLink, "_blank", "noreferrer");

    toast({
      title: "Opening WhatsApp…",
      description: "Send the message to get your quote faster.",
    });
    form.reset();
  }
